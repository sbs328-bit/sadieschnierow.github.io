const projects = [
  ...
  },
  {
    ...
    description: 'Led design strategy for Kids Fight Climate Change, a youth-led climate education movement.',
    image: '/images/kfcc.png',
    link: 'https://www.kidsfightclimatechange.org/',
    bg: '#CDCCCA',
  },
  {
    title: 'Sadie Bea Designs',
    date: { month: 'May', year: 2020 },
    description: 'Created an Etsy shop selling handmade stickers and jewelry.',
    image: '/images/sadiebeadesigns.png',
    link: 'https://www.etsy.com/shop/sadiebeadesigns',
    bg: '#e5bdea',
  },
  {
    title: 'Sadie Bea Cakes',
    date: { month: 'August', year: 2020 },
    description: 'Founded a bakeshop specializing in bespoke cakes for every occasion.',
    image: '/images/sadiebeacakes.png',
    link: 'https://www.instagram.com/sadiebeacakes/',
    bg: '#806954',
  },
]
